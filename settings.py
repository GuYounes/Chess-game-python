#ONLY SETTINGS YOU'RE ALLOWED TO MODIFY, THE RESCALE OF EVERYTHING IS AUTOMATIC
HEIGHTDISPLAY = 1000
...
BORDER_TO_CHESSBOARD = int( HEIGHTDISPLAY * 0.1 ) 

CHESSBOARD_SIDE = int(HEIGHTDISPLAY - 2 * BORDER_TO_CHESSBOARD)

SQUARE_SIDE = int(CHESSBOARD_SIDE /8) 
